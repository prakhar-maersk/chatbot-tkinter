...
def chat(user_response):
    ...
    if(user_response!='bye'):
        ...
        # elif (querys(user_response)!=None):
        #     return querys(user_response)
        # elif (browser(user_response)!=None):
        #     return browser(user_response)
        else:
            ...
            elif (querys(user_response)!=query):
                 return querys(user_response)
            # elif (browser(user_response)!=bro):
            #      return browser(user_response)
            # elif (basicR(user_response)!=None):
            #     return basicR(user_response)
            else:
